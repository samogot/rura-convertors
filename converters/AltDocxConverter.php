...
require_once(__DIR__ . '/../lib/docx/htmltodocx_converter/h2d_htmlconverter_alt.php');
 ...
 */
class AltDocxConverter extends Converter
{
...
//		exit;
        ...
        if ($this->seriestitle) {
            $descr['sequence'] = "<h1>" . $this->escapexml(
                    $this->seriestitle
                ) . ($this->seriesnum ? " {$this->seriesnum}" : '') . " </h1>";
        }
