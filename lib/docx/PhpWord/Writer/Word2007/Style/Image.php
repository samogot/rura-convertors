...
class Image extends AbstractStyle
{
    ...
    /*  
            ...
            Method _writeImage was changed
            Instead of pixels prints images in pointers. 
            Since all images in DOCX RuraConverter MUST fit the A4 page size,
            I replaced 'width:'.$width.'px;height:'.$height.'px' with 'width:'.$width.'pt;height:'.$height.'pt',
	    because A4 size can't be defined in pixels (platform dependent)
